...
import { AppShell, NAV_NUTRICIONISTA, NAV_ESCOLA, AppStyles } from './components/AppShell.jsx';
...
export default function App() {
      ...
      <>
        ...
        <TelaLogin
          ...
          onEntrar={(usuario) => {
            ...
            setTab(usuario.nivelAcesso === "nutricionista" ? "dashboard" : "novo");
          }}
        />
      </>
    );
  ...
  const navItems = acesso === "nutricionista" ? NAV_NUTRICIONISTA : NAV_ESCOLA;
